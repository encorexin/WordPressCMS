...
| Android | Capacitor + WebView | `pnpm build:apk` / `pnpm build:aab` | 同步到 `android/`，再由 Gradle 产出 `.apk` / `.aab` |
...
邀请测试链接：https://appgallery.huawei.com/link/invite-test-wap?taskId=810e705f7d86c5b9494a283364997503&invitationCode=AOp0X40apUL
---
...
pnpm build:aab        # 构建 Web 并同步 Android 工程（AAB 仍需 Gradle 打包）
```
